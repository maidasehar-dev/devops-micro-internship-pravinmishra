...
- For each FAIL or WARN, the estimated monthly cost or risk impact
- One exact, safe AWS CLI remediation command per finding for the human to review
...
6. Do not edit files.
7. Do not run any AWS CLI command that creates, modifies, deletes, stops, or terminates a resource.
